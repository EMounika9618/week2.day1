...
public class CreateContact {
	public static void main(String[] args) {
		...
		driver.findElement(By.id("lastNameField")).sendKeys("Ega");
		driver.findElement(By.id("createContactForm_firstNameLocal")).sendKeys("Emounika");
		driver.findElement(By.name("lastNameLocal")).sendKeys("K");
